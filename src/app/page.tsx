...
export default function Home() {
  const [remedies, setRemedies] = useState<
    SuggestRemediesOutput["remedies"] | null
  >(null);
  const [topRemedyFromMateriaMedica, setTopRemedyFromMateriaMedica] = useState<
    SuggestRemediesOutput["topRemedyFromMateriaMedica"] | null
  >(null);
  const [topRemedyFromBoericke, setTopRemedyFromBoericke] = useState<
    SuggestRemediesOutput["topRemedyFromBoericke"] | null
  >(null);
  const [topRemedyFromAI, setTopRemedyFromAI] = useState<
    SuggestRemediesOutput["topRemedyFromAI"] | null
  >(null);
  const [categorizedSymptoms, setCategorizedSymptoms] = useState<
    SuggestRemediesOutput["categorizedSymptoms"] | null
  >(null);
  const [bestRepertorySuggestion, setBestRepertorySuggestion] = useState<
    string | null
  >(null);
